...
printf "\nsshfs#$STORAGE_URL:/home/ $PROJECT_PATH/volumes/remote_files fuse defaults,allow_other,port=23,IdentityFile=$PROJECT_PATH/.ssh/storage,reconnect,ServerAliveInterval=15,ServerAliveCountMax=3 0 0" >>/etc/fstab
